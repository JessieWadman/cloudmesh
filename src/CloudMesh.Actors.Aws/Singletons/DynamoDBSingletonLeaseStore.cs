...
namespace CloudMesh.Actors.Aws.Singletons
{
    public class DynamoDBSingletonLeaseStore : ISingletonLeaseProvider
    {
        private readonly string tableName;

        public DynamoDBSingletonLeaseStore(string tableName)
        {
        ...
        public ValueTask<ISingletonLease?> TryAcquire(
            ...
            => DynamoDBSingletonLease.TryAcquire(tableName, singletonName, leaseDuration, stoppingToken, instanceId);
    }
    ...
    public class DynamoDBSingletonLease : ISingletonLease
    {
            ...
            string? instanceId = null)
        {
            ...
            if (leaseDto is not null)
                return new DynamoDBSingletonLease(tableName, singletonName, leaseDto.UserData, leaseDto.InstanceId);
            return null;
        }

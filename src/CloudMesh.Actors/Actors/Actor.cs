...
namespace CloudMesh.Actors
{
    public abstract class Actor : IHostedActor, IActor
    {
        ...
        private Channel<MethodInvocationEnvelope> inbox;
        ...
        protected ResourceIdentifier Sender { get; private set; }
        protected long MessageId { get; private set; }

        protected Actor()
        {
            inbox = Channel.CreateBounded<MethodInvocationEnvelope>(1);
        ...
        Channel<MethodInvocationEnvelope> IHostedActor.GetInbox() => inbox;
